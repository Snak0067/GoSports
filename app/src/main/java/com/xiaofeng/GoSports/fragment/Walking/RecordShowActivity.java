...
import com.xiaofeng.GoSports.utils.path.TraceRePlay;
...
public class RecordShowActivity extends Activity implements
    ...
    private void setupRecord() {
        ...
        try {
            mTraceClient = new LBSTraceClient(
        ...
        if (mRecord != null) {
            ...
            LatLng endLatLng = new LatLng(endLoc.getLatitude(),
                    endLoc.getLongitude());
            mOriginLatLngList = RecordUtil.parseLatLngList(recordList);
            addOriginTrace(startLatLng, endLatLng, mOriginLatLngList);

            List<TraceLocation> mGraspTraceLocationList = RecordUtil
